...
public class ProjectsList_test extends Settings {
    ...
    public void reSave_equip() throws Exception {
        ...
        //GO TO CAR EDIT PAGE
        browser.findElement(By.xpath("//*[@id=\"app\"]/div[2]/div/div/div[2]/div[3]/table/tbody/tr[1]/td[4]/div/a/button")).click();
        Thread.sleep(3000);
        ...
        //GO TO EQUIP
        browser.findElement(By.xpath("//*[@id=\"equipment\"]/div[1]/div[3]/table/tbody/tr[1]/td[4]/div/a/button")).click();
        Thread.sleep(3000);
